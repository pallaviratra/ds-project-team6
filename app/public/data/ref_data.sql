...
create table game_details (
	game_id PRIMARY KEY AUTOINCREMENT INT,
	date DATE,
	time VARCHAR(50),
	field VARCHAR(50),
...
insert into ref_assignment (assign_id, game_id, ref_id, assign_status) values (9, 9, 0, '');
insert into ref_assignment (assign_id, game_id, ref_id, assign_status) values (10, 10, 0, '');
insert into ref_assignment (assign_id, game_id, ref_id, assign_status) values (7, 7, 0, '');
insert into ref_assignment (assign_id, game_id, ref_id, assign_status) values (8, 8, 0, '');
insert into ref_assignment (assign_id, game_id, ref_id, assign_status) values (9, 9, 0, '');
insert into ref_assignment (assign_id, game_id, ref_id, assign_status) values (10, 10, 0, '');
